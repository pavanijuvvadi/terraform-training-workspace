...
module "ecs_service" {
  ...
  discovery_namespace_name        = "${var.discovery_namespace_name}"
  original_public_route53_zone_id = "${var.original_public_route53_zone_id}"
  new_route53_zone_id             = "${var.public_namespace_hosted_zone}"
